	...
	public function get_settings(): ProviderSettingsFieldsDTO {
		...
		$dto->set_fields( [
			...
			[
				...
				'placeholder' => 'ex. Write desciption text here',
				'default'     => 'Enter your registered email address to receive a quick login link directly in your inbox.',
				'type'        => 'textarea',
				'tab'         => 'email-magic-link',
				'if_has'      => ['email_magic_link_enable'],
			],
			...
			[
				...
				'default'     => 'Continue with magic link',
				'type'        => 'text',
				'tab'         => 'email-magic-link',
				'if_has'      => ['email_magic_link_enable'],
			],
